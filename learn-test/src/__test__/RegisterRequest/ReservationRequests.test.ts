...
describe("Reservation requests", () => {
  ...
  const getAllElementsSpy = vi.spyOn(DataBase.prototype, "getAllElements");
  const updateSpy = vi.spyOn(DataBase.prototype, "update");
  const deleteSpy = vi.spyOn(DataBase.prototype, "delete");
